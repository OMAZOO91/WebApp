...
func(x);
console.log(`func 호출한 후 x = ${x}`);
console.log("=============================================================================");

function func2(o)
{
    console.log(o);
    o.message = `func2안에서 수정함(이전 값: ${o.message})`;
    console.log(o);
}
...
func2(o2)
console.log(`func2를 호출 후: "${o2.message}"`);
console.log("=============================================================================");
...
function func3(o)
{
    ...
    o = {message:"새로운 객체"};
    console.log(`func3내부 : o.message = "${o.message}"(할당 후)`);
}

var o3 = {message: "초기값"};
console.log(`func3를 호출하기 전: "${o3.message}"`);
func3(o3)
console.log(`func3를 호출 후: "${o3.message}"`);
console.log("=============================================================================");
...
o4 =func4(o4)
console.log(`func4를 호출 후: "${o4.message}"`);
console.log("=============================================================================");
...
console.log(bruce);
update.call(madeline,1955,"actor");
...
let globalFunc
{
    let blockVar ='a';
    globalFunc = function(){
        console.log("ㅇㅇㅇ" + blockVar);
    }
}
console.log(typeof globalFunc);
globalFunc();
console.log("===============================================================================");
//함수 Closure:함수를 특정 scope에 접근할 수 있도록 의도적으로 해당 scope에 함수 정의
let fs4;
{
    let o = {note:'safe'};
    fs4 = function(){return o;}
}
console.log("Check: " + fs4);
console.log(typeof fs4);
console.log(fs4());
let oRef = fs4();
console.log(typeof oRef);   console.log(oRef);
oRef = "Not so safe after all";
console.log(oRef);
