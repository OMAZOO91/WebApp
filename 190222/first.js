...
var dialog = 'Sam looked up, and said "hello, old friend"m as Max walked in.';
...
const message2 = `The current temperature is  ${currentTemp} \u00b0c`; //ES6이후 가능.
console.log(message);
...
const RED = Symbol("The color of a sunset!");   //ES6 Symbol type:유일한 값을 갖게하는 타입.
const ORANGE = Symbol("The color of a sunset!"); //ES6
console.log(RED);
console.log(ORANGE);
console.log(RED===ORANGE); //===완전히 같은지
...
var arr = ['a', 'b', 'c'];
console.log(arr); console.log(arr.length); console.log(arr[0]);
console.log(arr[arr.length-1]);
var arr2 = [1,2,'c',4,5]; console.log(arr2);
arr2[2] = 3; console.log(arr2);
