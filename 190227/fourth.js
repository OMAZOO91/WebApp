...
let arr4 = [
    {name:"Fred", type:"object",luckyNumber:[5,7,3]},
    [
...
console.log("---------------------------------Splice-----------------------------------");
//SPlice : 추가 Or 삭제할떄 사용하는 함수. 인수 2개 필수.
//Splice(1,2) 1번 인덱스 2번은 명령(0:추가, 0보다 크면 삭제(ex:2개 삭제.).)
let arr12 = [1,5,7];
console.log(arr12);
...
// 1번째 인수: 복사한 값 저장할 위치 인덱스. 2번쨰 인수: 복사를 시작할 인덱스.
let arr13 = [1,2,3,4];
console.log(arr13);
...
arr15.sort();
console.log(arr15);
arr15.sort((a,b)=> a.name > b.name); //Call Back 함수.(System 내부에서 자동호출.)
console.log(arr15);
arr15.sort((a,b)=> a.name[1] < b.name[1]);
console.log(arr15);
console.log("---------------------------------Sort End-----------------------------------");
console.log("--------------------------------IndexOf-----------------------------------");
//indexOf: 찾는값 처음 나오는 위치 리턴.(찾는 값을 못찾으면 -1 리턴.)
const o = {name:"Jerry"};
...
let array = [1,5,2,7,5,10,5,8,6,9];
let searchResult = [];

let search;

search=array.indexOf(5,0);
//indexOf를 이용한 중복된 위치 찾기.
while(search!=-1)
{
...
console.log("-----------------------------Some & Every END---------------------------------");
console.log("-----------------------------MAP---------------------------------");
//배열을 변형할때 사용.(자체를 변경시키지 않음.)
